		...
		<section className={styles.GameMechanism} id="game-mechanism">
			<div ref={containerRef} className={styles.imageContainer}>
				...
				<div className={styles.container}>
					...
					>
						Gear up your hero with the best NFTs to fight against
						Gata’aga and collect daily rewards in Dyseum!
					</p>
					<div
						className={styles.cardsDecorContainer}
						...
						<div ref={contentRef}>
							...
							<div className={styles.cards}>
								...
								>
									...
									></div>
									<div
										className={styles.decorSquareContainer}
									>
										<DecorSquare />
									</div>
									<h3
									...
									<p style={gearHiddenTextStyle}>
										Gear up your hero with NFT wearables,
										restock with supply and repair your
										items!
									</p>
								</div>
								<div ref={fightCardRef} className={styles.card}>
									...
									<p style={fightHiddenTextStyle}>
										Fight and slay Gata’aga using your
										skills and abilities, or send your
										character to Legion mode!
									</p>
								</div>
								<div ref={earnCardRef} className={styles.card}>
									...
									<p style={earnHiddenTextStyle}>
										Collect the daily reward in Dyseum based
										on your NFTs and performance!
									</p>
								</div>
								<div
									ref={repeatCardRef}
